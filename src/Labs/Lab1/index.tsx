    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Boil pasta</li>
          <li>In a pan mix milk, butter and flour to make the white sauce</li>
          <li>Add boiled pasta in the white sauce</li>
          <li>Mix well and garnish with herbs</li>
        </ol>
      ...
      <div id="wd-forms">
        ...
        <form id="wd-text-fields">
          ...
          <textarea id="wd-textarea" cols={30} rows={10}>
            ...
            cursus nisl. Donec aliquet ex aliquam neque scelerisque, ut blandit
            velit mollis. Praesent aliquam at nunc a faucibus. Etiam quis metus
            a lorem commodo aliquet. Pellentesque tincidunt odio quam, id auctor
            odio ornare et. Aenean sit amet elementum lorem. Vestibulum luctus
            iaculis nulla nec placerat. Vestibulum aliquet libero sed eleifend
            tristique.
          </textarea>
          {/* BUTTONS */}
